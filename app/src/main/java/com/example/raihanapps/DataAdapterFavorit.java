...
public class DataAdapterFavorit extends RecyclerView.Adapter<DataAdapterFavorit.DatakuViewHolder> {
    private List<ModelSepakBolaRealm> dataList;
    ...
    public DataAdapterFavorit(List<ModelSepakBolaRealm> dataList, Callback callback) {
